/*
(customer) Write a C program that repeatedly reads in customer data from the user and prints the
...
printCustomer() takes a parameter acct and then prints the customer information.
*/
#include <stdio.h>
#include <string.h>
struct account
